return {
  {
    ...
    -- },
    {
      ...
      opts = {
        ...
        transparent_mode = true, -- fondo transparente como en tus otros temas
        -- Puedes ajustar contraste, etc.:
        -- contrast = "hard", -- "soft" | "medium" | "hard"
      },
      config = function(_, opts)
        require("gruvbox").setup(opts)
        -- Cuando el colorscheme activo sea gruvbox, iguala los "bg = none"
        vim.api.nvim_create_autocmd("ColorScheme", {
          ...
          callback = function()
            ...
            set(0, "LspInfoBorder", { bg = "none" })
            -- gutter/sidebars:
            set(0, "SignColumn", { bg = "none" })
            set(0, "Normal", { bg = "none" }) -- respeta transparent_mode
          end,
        })
      end,
    },
    ...
    },
    {
      "LazyVim/LazyVim",
      opts = {
        colorscheme = "gruvbox" -- "catppuccin", "kanagawa", "oldworld"
      },
    },
  },
}
